...
{
    public class Creatureentity : Creature
    {
        protected readonly Elvencurse2.Client.ElvenCurse2 _game;
        ...
        public Creatureentity(Elvencurse2.Client.ElvenCurse2 game, Payload payload) : base(null, null, Creaturetype.Player)
        {
            _game = game;
            _payload = payload;
        ...
        {
            ThreadPool.QueueUserWorkItem(CreateEntitysprite);
        }

        public virtual bool Update(float deltaSeconds, KeyboardState keyboardState)
        {
            if (!IsLoaded)
            {
                return false;
            ...
            //else
            //{// det er for tungt at kører dette hele tiden...
            //    _sprite.Play("idle");
            //}
        ...
        protected Direction Vector2ToDirection(Vector2 vector)
        {
        ...
        protected virtual void CreateEntitysprite(object o)
        {
            Texture2D texture;
            ...
            animationfactory.Add("idle", new SpriteSheetAnimationData(new[] { 130 }, isLooping: false));
